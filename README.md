...
├── contact.html            联系我们
├── /motif-bio-website/css/style.css           全部样式(单文件,带 ?v=N 缓存版本号)
├── /motif-bio-website/js/main.js              所有交互
...
```html
<link rel="stylesheet" href="/motif-bio-website/css/style.css?v=55" />
<script src="/motif-bio-website/js/main.js?v=55"></script>
```

当前版本:**v55**(详见 `/motif-bio-website/css/style.css` 末尾的版本注释)。
